...
import {fun} from "../../src/SearchService/UnPublishGigsHandler"
...
describe('UnPublishGigsHandler', function() {
  ...
  it('Validate', async function() {
    ...
    expect(response.data)
      .to.have.property("_source")
      .to.have.property("enabled").with.equal(false)
  })
